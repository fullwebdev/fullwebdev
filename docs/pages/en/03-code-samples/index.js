...
export default () => html`
  ...
  <p>
    Minimalists code samples & demos, without any need for a build system nor a
    package manager.
  </p>
  ...
  <p>
    ...
    <a href="https://code.visualstudio.com/docs/editor/codebasics#_folding"
      >VS Code folding regions</a
    >) of these files are embeded in some other writings and documentations
    using
    <a href="https://github.com/noelmace/pandoc-import-code"
      >pandoc-import-code</a
    >
    (cf. <a href="/06-materials/">Instructional Materials</a>).
  </p>
