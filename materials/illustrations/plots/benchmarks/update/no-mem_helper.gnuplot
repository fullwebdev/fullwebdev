...
output_file = working_directory."no-mem_helper.png"
...
plot '<(egrep "^(VanillaJS|this.tbody.children|Helper|Inferno|Children \(Template String\)|lit-html|React)," '.data_file.')' \
