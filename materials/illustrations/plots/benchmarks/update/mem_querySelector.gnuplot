...
output_file = working_directory."mem_querySelector.png"
...
plot '<(egrep "^(VanillaJS|this.tbody.children|Helper|this.tbody.querySelector|this.rows\[id\].querySelector|React)," '.data_file.')' \
