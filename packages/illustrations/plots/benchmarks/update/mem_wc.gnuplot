...
output_file = working_directory."mem_wc.png"
...
plot '<(egrep "^(VanillaJS|this.rows\[id\].children|this.tbody.children|this.rows\[id\].querySelector|Helper|React|élément personnalisé)," '.data_file.')' \
