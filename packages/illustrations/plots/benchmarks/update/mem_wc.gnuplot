...
plot '<(egrep "^(VanillaJS|this.rows\[id\].children|this.tbody.children|this.rows\[id\].querySelector|Helper|React|élément personnalisé)," data.csv)' \
