...
plot '<(egrep "^(VanillaJS|this.rows\[id\].children|this.toby.children|this.rows\[id\].querySelector|Helper|React|this.tbody.querySelector)," data.csv)' \
