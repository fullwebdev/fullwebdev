...
set output "mem_innerHTML-cpnt.png"
...
plot '<(egrep "^(VanillaJS|this.tboby.children|this.rows\[id\].children|this.rows\[id\].querySelector|Helper|React|Template String|Template String \(avec cache\)|pseudo-composant innerHTML|élément personnalisé)," data.csv)' \
