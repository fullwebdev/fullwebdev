...
output_file = working_directory."mem_innerHTML.png"
...
plot '<(egrep "^(VanillaJS|this.tbody.children|this.rows\[id\].children|this.rows\[id\].querySelector|Helper|React|this.tbody.querySelector|Children \(Template String\)|Template String \(avec cache\))," '.data_file.')' \
