...
set output "clone-node_innerHTML.png"
...
plot '<(egrep "^(VanillaJS|VanillaJS \(DX\)|Inferno|React|lit-html|innerHTML|pseudo-composant innerHTML|createElement \+ cloneNode)," data.csv)' \
