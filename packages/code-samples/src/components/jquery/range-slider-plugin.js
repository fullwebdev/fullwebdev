...
(function (factory) {
  ...
  function Plugin(element, options) {
    ...
    this.DIMENSION =
      constants.orientation[this.orientation].dimension;
    this.DIRECTION =
    ...
    this.$element.on("change." + this.identifier, function (
      e,
      data
    ) {
  ...
  Plugin.prototype.update = function (
    ...
    if (updateAttributes) {
      this.min = tryParseFloat(
        this.$element[0].getAttribute("min"),
        0
      );
      this.max = tryParseFloat(
  ...
  Plugin.prototype.handleDown = function (e) {
    ...
    var pos = this.getRelativePosition(e),
      rangePos = this.$range[0].getBoundingClientRect()[
        this.DIRECTION
      ],
      handlePos =
        this.getPositionFromNode(this.$handle[0]) -
        rangePos,
      setPos =
    ...
    if (
      pos >= handlePos &&
      pos < handlePos + this.handleDimension
    ) {
  ...
  Plugin.prototype.setPosition = function (
    ...
    // Snapping steps
    value = this.getValueFromPosition(
      this.cap(pos, 0, this.maxHandlePos)
    );
    newPos = this.getPositionFromValue(value);

    // Update ui
    this.$fill[0].style[this.DIMENSION] =
      newPos + this.grabPos + "px";
  ...
  Plugin.prototype.getRelativePosition = function (e) {
    ...
    if (
      typeof e.originalEvent["client" + ucCoordinate] !==
      "undefined"
    ) {
      pageCoordinate =
        e.originalEvent["client" + ucCoordinate];
    } else if (
      ...
      pageCoordinate =
        e.originalEvent.touches[0]["client" + ucCoordinate];
    } else if (
      e.currentPoint &&
  ...
  Plugin.prototype.getPositionFromValue = function (value) {
    ...
    pos = !Number.isNaN(percentage)
      ? percentage * this.maxHandlePos
      : 0;
    return pos;
  };
