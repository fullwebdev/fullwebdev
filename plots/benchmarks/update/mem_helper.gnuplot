...
output_file = working_directory."mem_helper.png"
...
plot '<(egrep "^(VanillaJS|this.rows\[id\].children|this.tbody.children|Helper avec cache|this.rows\[id\].querySelector|Helper|React|this.tbody.querySelector)," '.data_file.')' \
