...
output_file = working_directory."innerHTML-cpnt.png"
...
plot "<(egrep '^(VanillaJS|createElement|Inferno|React|lit-html|innerHTML|pseudo-composant innerHTML|élément personnalisé),' ".data_file.")" \
